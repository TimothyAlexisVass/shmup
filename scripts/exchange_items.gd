...
func _on_item_1_item_selected(selected_index):
	...
	$Amounts1/Item1.text = exchange_rates[0]
	$Amounts2/Item1.text = exchange_rates[1]
	$Amounts1/Item2.text = exchange_rates[2]
	$Amounts2/Item2.text = exchange_rates[3]
	set_visibility()
...
func _on_item_2_item_selected(selected_index):
	...
	$Amounts1/Item1.text = exchange_rates[3]
	$Amounts2/Item1.text = exchange_rates[2]
	$Amounts1/Item2.text = exchange_rates[1]
	$Amounts2/Item2.text = exchange_rates[0]
	set_visibility()
